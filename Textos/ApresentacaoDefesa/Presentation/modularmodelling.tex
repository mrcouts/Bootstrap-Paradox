...
\begin{frame}{Introdução}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[scale=0.30]{Simulador.jpg}
    \end{figure}  
\end{frame}
...
\begin{frame}{Introdução}
    ...
    \begin{figure}[!h]
        \centering
        \includegraphics[scale=0.25]{Usinagem1.jpg}
    \end{figure}

    \begin{figure}[!h]
        \centering
        \includegraphics[scale=0.10]{Usinagem2.jpg}
    \end{figure}
    \end{multicols}
\end{frame}
...
\begin{frame}{Objetivos}
	...
	\begin{exampleblock}{Como?}
		%\pause
		\begin{itemize}
			\item[$\bullet$] Contribuir no processo de geração de modelos dinâmicos \\[8pt]
			%\pause
			\item[$\bullet$] Investigar a possibilidade de utilizar/sintetizar leis de controle de maior desempenho do que as propostas na literatura \\[8pt]
			%\pause
			\item[$\bullet$] Comparar o desempenho diversas estratégias de controle, tanto as mais encontradas na literatura quanto as quanto as estratégias de controle propostas, atrav\'es de ensaios experimentais \\[8pt]
		\end{itemize}
	\end{exampleblock}
\end{frame}
...
\begin{frame}{Experimento}
    \framesubtitle{PDq - Trajetória circular}
	\begin{figure}[!htb]
		\centering
...
\begin{frame}{Experimento}
    \framesubtitle{TCMDx - Trajetória circular}
	\begin{figure}[!htb]
		\centering
...
\begin{frame}{Experimento}
    \framesubtitle{PDq - Trajetória triangular}
	\begin{figure}[!htb]
		\centering
...
\begin{frame}{Experimento}
    \framesubtitle{TCMDx - Trajetória triangular}
	\begin{figure}[!htb]
		\centering
