...
A velocidade angular de cada ligamento pode ser obtida aplicando recursivamente o príncipio da composição de movimentos para velocidades angulares \cite{Tenenbaum}:
...
A aceleração do centro de massa de cada ligamento pode ser obtida aplicando recursivamente o príncipio da composição de movimentos para acelerações lineares \cite{Tenenbaum}:
...
A aceleração angular de cada ligamento pode ser obtida aplicando recursivamente o príncipio da composição de movimentos para acelerações angulares \cite{Tenenbaum}:
