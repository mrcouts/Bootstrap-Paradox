...
A = txt2py("aquisicao_triangulo_PIDSMCx_lambda60_phi6_k103_0_3.txt")
...
plt.xlabel(r'$t[ms]$')
plt.ylabel(r'$s_x[m/s^2]$')
plt.title('Vari' + u'á' + 'vel de escorregamento ' + 'em fun'  + u'ç' + u'ã' 'o do tempo (coordenada x)')
plt.savefig('s1.png')

plt.figure()
plt.plot(t_np, s2_np, 'r', linewidth=2)
plt.xlabel(r'$t[ms]$')
plt.ylabel(r'$s_y[m/s^2]$')
plt.title('Vari' + u'á' + 'vel de escorregamento ' + 'em fun'  + u'ç' + u'ã' 'o do tempo (coordenada y)')
plt.savefig('s2.png')